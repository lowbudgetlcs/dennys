...
@JvmInline
value class RiotTournamentId(val value: Int)

fun Int.toRiotTournamentId(): RiotTournamentId = RiotTournamentId(this)

data class RiotTournament(val id: RiotTournamentId, val name: String)

data class NewRiotTournament(val name: String)
