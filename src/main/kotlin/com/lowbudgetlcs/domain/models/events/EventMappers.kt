...
fun NewEventGroup.toEventGroup(id: EventGroupId): EventGroup = EventGroup(id = id, name = name)

fun NewEvent.toEvent(id: EventId, createdAt: Instant, tournamentId: TournamentId): Event =
        Event(
                id = id,
                name = name,
...
fun EventWithTeams.toEvent(): Event =
        Event(
                id = id,
                name = name,
                description = description,
