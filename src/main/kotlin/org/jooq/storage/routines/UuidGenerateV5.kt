...
open class UuidGenerateV5 : AbstractRoutine<UUID>("uuid_generate_v5", Dennys.DENNYS, SQLDataType.UUID) {
    companion object {

        /**
         * The parameter <code>dennys.uuid_generate_v5.RETURN_VALUE</code>.
         */
        val RETURN_VALUE: Parameter<UUID?> = Internal.createParameter("RETURN_VALUE", SQLDataType.UUID, false, false)

        /**
         * The parameter <code>dennys.uuid_generate_v5.namespace</code>.
         */
        val NAMESPACE: Parameter<UUID?> = Internal.createParameter("namespace", SQLDataType.UUID, false, false)

        /**
         * The parameter <code>dennys.uuid_generate_v5.name</code>.
         */
