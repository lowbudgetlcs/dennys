...
open class UuidGenerateV3 : AbstractRoutine<UUID>("uuid_generate_v3", Dennys.DENNYS, SQLDataType.UUID) {
    companion object {

        /**
         * The parameter <code>dennys.uuid_generate_v3.RETURN_VALUE</code>.
         */
        val RETURN_VALUE: Parameter<UUID?> = Internal.createParameter("RETURN_VALUE", SQLDataType.UUID, false, false)

        /**
         * The parameter <code>dennys.uuid_generate_v3.namespace</code>.
         */
        val NAMESPACE: Parameter<UUID?> = Internal.createParameter("namespace", SQLDataType.UUID, false, false)

        /**
         * The parameter <code>dennys.uuid_generate_v3.name</code>.
         */
