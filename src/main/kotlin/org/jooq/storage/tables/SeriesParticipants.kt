...
open class SeriesParticipants(
    ...
    override fun getReferences(): List<ForeignKey<SeriesParticipantsRecord, *>> = listOf(SERIES_PARTICIPANTS__SERIES_PARTICIPANTS_SERIES_ID_FKEY, SERIES_PARTICIPANTS__SERIES_PARTICIPANTS_TEAM_ID_FKEY)
