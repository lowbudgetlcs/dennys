...
val EVENT_AUDIT_LOG__EVENT_AUDIT_LOG_EVENT_ID_FKEY: ForeignKey<EventAuditLogRecord, EventsRecord> = Internal.createForeignKey(EventAuditLog.EVENT_AUDIT_LOG, DSL.name("event_audit_log_event_id_fkey"), arrayOf(EventAuditLog.EVENT_AUDIT_LOG.EVENT_ID), org.jooq.storage.keys.EVENTS_PKEY, arrayOf(Events.EVENTS.ID), true)
val GAMES__GAMES_BLUE_TEAM_FKEY: ForeignKey<GamesRecord, TeamsRecord> = Internal.createForeignKey(Games.GAMES, DSL.name("games_blue_team_fkey"), arrayOf(Games.GAMES.BLUE_TEAM), org.jooq.storage.keys.TEAMS_PKEY, arrayOf(Teams.TEAMS.ID), true)
val GAMES__GAMES_RED_TEAM_FKEY: ForeignKey<GamesRecord, TeamsRecord> = Internal.createForeignKey(Games.GAMES, DSL.name("games_red_team_fkey"), arrayOf(Games.GAMES.RED_TEAM), org.jooq.storage.keys.TEAMS_PKEY, arrayOf(Teams.TEAMS.ID), true)
...
val GAMES_RESULTS__GAMES_RESULTS_GAME_ID_FKEY: ForeignKey<GamesResultsRecord, GamesRecord> = Internal.createForeignKey(GamesResults.GAMES_RESULTS, DSL.name("games_results_game_id_fkey"), arrayOf(GamesResults.GAMES_RESULTS.GAME_ID), org.jooq.storage.keys.GAMES_PKEY, arrayOf(Games.GAMES.ID), true)
val GAMES_RESULTS__GAMES_RESULTS_LOSER_FKEY: ForeignKey<GamesResultsRecord, TeamsRecord> = Internal.createForeignKey(GamesResults.GAMES_RESULTS, DSL.name("games_results_loser_fkey"), arrayOf(GamesResults.GAMES_RESULTS.LOSER), org.jooq.storage.keys.TEAMS_PKEY, arrayOf(Teams.TEAMS.ID), true)
val GAMES_RESULTS__GAMES_RESULTS_WINNER_FKEY: ForeignKey<GamesResultsRecord, TeamsRecord> = Internal.createForeignKey(GamesResults.GAMES_RESULTS, DSL.name("games_results_winner_fkey"), arrayOf(GamesResults.GAMES_RESULTS.WINNER), org.jooq.storage.keys.TEAMS_PKEY, arrayOf(Teams.TEAMS.ID), true)
val PLAYER_AUDIT_LOGS__PLAYER_AUDIT_LOGS_PLAYER_ID_FKEY: ForeignKey<PlayerAuditLogsRecord, PlayersRecord> = Internal.createForeignKey(PlayerAuditLogs.PLAYER_AUDIT_LOGS, DSL.name("player_audit_logs_player_id_fkey"), arrayOf(PlayerAuditLogs.PLAYER_AUDIT_LOGS.PLAYER_ID), org.jooq.storage.keys.PLAYERS_PKEY, arrayOf(Players.PLAYERS.ID), true)
...
val SERIES_RESULTS__SERIES_RESULTS_WINNER_FKEY: ForeignKey<SeriesResultsRecord, TeamsRecord> = Internal.createForeignKey(SeriesResults.SERIES_RESULTS, DSL.name("series_results_winner_fkey"), arrayOf(SeriesResults.SERIES_RESULTS.WINNER), org.jooq.storage.keys.TEAMS_PKEY, arrayOf(Teams.TEAMS.ID), true)
val TEAM_AUDIT_LOGS__TEAM_AUDIT_LOGS_TEAM_ID_FKEY: ForeignKey<TeamAuditLogsRecord, TeamsRecord> = Internal.createForeignKey(TeamAuditLogs.TEAM_AUDIT_LOGS, DSL.name("team_audit_logs_team_id_fkey"), arrayOf(TeamAuditLogs.TEAM_AUDIT_LOGS.TEAM_ID), org.jooq.storage.keys.TEAMS_PKEY, arrayOf(Teams.TEAMS.ID), true)
