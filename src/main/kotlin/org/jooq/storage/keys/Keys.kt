...
val EVENT_AUDIT_LOGS_PKEY: UniqueKey<EventAuditLogsRecord> = Internal.createUniqueKey(EventAuditLogs.EVENT_AUDIT_LOGS, DSL.name("event_audit_logs_pkey"), arrayOf(EventAuditLogs.EVENT_AUDIT_LOGS.ID), true)
...
val RIOT_ACCOUNT_AUDIT_LOGS_PKEY: UniqueKey<RiotAccountAuditLogsRecord> = Internal.createUniqueKey(RiotAccountAuditLogs.RIOT_ACCOUNT_AUDIT_LOGS, DSL.name("riot_account_audit_logs_pkey"), arrayOf(RiotAccountAuditLogs.RIOT_ACCOUNT_AUDIT_LOGS.ID), true)
...
val EVENT_AUDIT_LOGS__EVENT_AUDIT_LOGS_EVENT_ID_FKEY: ForeignKey<EventAuditLogsRecord, EventsRecord> = Internal.createForeignKey(EventAuditLogs.EVENT_AUDIT_LOGS, DSL.name("event_audit_logs_event_id_fkey"), arrayOf(EventAuditLogs.EVENT_AUDIT_LOGS.EVENT_ID), org.jooq.storage.keys.EVENTS_PKEY, arrayOf(Events.EVENTS.ID), true)
...
val RIOT_ACCOUNT_AUDIT_LOGS__RIOT_ACCOUNT_AUDIT_LOGS_RIOT_ACCOUNT_ID_FKEY: ForeignKey<RiotAccountAuditLogsRecord, RiotAccountsRecord> = Internal.createForeignKey(RiotAccountAuditLogs.RIOT_ACCOUNT_AUDIT_LOGS, DSL.name("riot_account_audit_logs_riot_account_id_fkey"), arrayOf(RiotAccountAuditLogs.RIOT_ACCOUNT_AUDIT_LOGS.RIOT_ACCOUNT_ID), org.jooq.storage.keys.RIOT_ACCOUNTS_PKEY, arrayOf(RiotAccounts.RIOT_ACCOUNTS.ID), true)
