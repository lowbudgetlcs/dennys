...
val GAMES_RESULTS__GAMES_RESULTS_LOSER_TEAM_ID_FKEY: ForeignKey<GamesResultsRecord, TeamsRecord> = Internal.createForeignKey(GamesResults.GAMES_RESULTS, DSL.name("games_results_loser_team_id_fkey"), arrayOf(GamesResults.GAMES_RESULTS.LOSER_TEAM_ID), org.jooq.storage.keys.TEAMS_PKEY, arrayOf(Teams.TEAMS.ID), true)
val GAMES_RESULTS__GAMES_RESULTS_WINNER_TEAM_ID_FKEY: ForeignKey<GamesResultsRecord, TeamsRecord> = Internal.createForeignKey(GamesResults.GAMES_RESULTS, DSL.name("games_results_winner_team_id_fkey"), arrayOf(GamesResults.GAMES_RESULTS.WINNER_TEAM_ID), org.jooq.storage.keys.TEAMS_PKEY, arrayOf(Teams.TEAMS.ID), true)
