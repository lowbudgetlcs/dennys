...
1. Clone the repo
   ...
   ```
2. Create a developer account at [Riot](https://developer.riotgames.com) and provision an API token.
...
6. Generate the sql migrations for a local database
    ...
    ```
   This can also be done in the IntelliJ `gradle` sidebar.
...
[license-url]: https://github.com/lowbudgetlcs/dennys/blob/master/LICENSE.txt
